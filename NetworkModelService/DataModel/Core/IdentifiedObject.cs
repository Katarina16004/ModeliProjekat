...
namespace FTN.Services.NetworkModelService.DataModel.Core
{
    ...
    public class IdentifiedObject
    {
        ...
        /// <summary>
        /// Global id of the identified object (SystemId - 4 nibbles, DMSType - 4 nibbles, FragmentId - 8 nibbles)
        /// </summary>
        ...
        public override bool Equals(object x)
        {
            ...
            else
            {
                ...
                return ((io.GlobalId == this.GlobalId) && (io.name == this.name) &&
                        (io.mrid == this.mrid) && (io.aliasName == this.aliasName));
            }
        }
        ...
        public virtual void SetProperty(Property property)
        {
            switch (property.Id)
            {
                ...
                // GID se postavlja samo kroz konstruktor
        ...
        {
            // Base implementation - no references
            return;
        }
        ...
        /// <summary>
        /// Gets all references (both Target and Reference type).
        /// </summary>
        ...
        /// <summary>
        /// Returns ResourceDescription for this entity.
        /// </summary>
        /// <param name="onlySettableAttributes">If true, returns only settable attributes.</param>
        public ResourceDescription GetAsResourceDescription(bool onlySettableAttributes)
        {
            ...
            foreach (ModelCode propId in props)
            {
                rd.AddProperty(GetProperty(propId));
            }
        ...
        /// <summary>
        /// Returns ResourceDescription with specified properties.
        /// </summary>
        ...
        /// <summary>
        /// Compares this object with another and returns different properties.
        /// </summary>
